...
Hooks:PostHook(PlayerManager,"on_headshot_dealt","noblehud_buff_bullseye",function(self)
...
Hooks:PostHook(PlayerManager,"_on_enter_shock_and_awe_event","noblehud_buff_lock_n_load",function(self)
...
--Hooks:PostHook(PlayerManager,"set_damage_absorption","noblehud_buff_hysteria",function(self,key,value)
	NobleHUD:log("Absorption " .. tostring(key) .. "," .. tostring(value) .. "/" .. tostring(Application:digest_value(value, true)) .. ", total " .. tostring(self:damage_absorption()))
--end)
